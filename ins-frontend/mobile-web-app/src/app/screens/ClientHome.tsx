  ...
  const cards = [
    {
      ...
      description: 'Get help nearby (plumber, painter, handyman…)',
      icon: Wrench,
      color: 'bg-blue-50 text-blue-600',
      category: 'local-services' as const,
      manualRoute: '/local-services/new',
    },
    {
      title: 'Employees',
      description: 'Hire for a role (assistant, driver, admin…)',
      icon: Briefcase,
      color: 'bg-green-50 text-green-600',
      category: 'jobs' as const,
      manualRoute: '/jobs/employer/new',
    },
    {
      title: 'Projects',
      description: 'Hire remote talent (website, logo, sound engineer…)',
      icon: Rocket,
      color: 'bg-purple-50 text-purple-600',
      category: 'projects' as const,
      manualRoute: '/projects/new',
    },
  ];
    ...
    <>
      <div className="flex flex-col h-full bg-gray-50">
        <div className="p-4 md:p-6 lg:p-8">
          ...
          <p className="text-gray-600 text-sm md:text-base">What do you need help with today?</p>
        </div>
